...
# 其他魔术方法(构造函数也属于)：内置的类方法，可以实现各自特殊的功能，类似于C++中的运算符重载
#   __str__：控制类转换成字符串的行为或者说print的行为，必须要有return
#   __lt__：自行定义实现类对象大于或小于的功能比较，return为True或False
#   __le__：自行定义实现类对象大于等于或小于等于的功能比较，return为True或False
#   __eq__：自行定义实现类对象等于的功能判断，return为True或False
# 私有成员
#-----------------------------------------------------------------------------------------------------------------------
